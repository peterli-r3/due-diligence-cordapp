...
import net.corda.samples.duediligence.contracts.TaxesDocumentsContract;
...
// * State *
// *********
@BelongsToContract(TaxesDocumentsContract.class)
public class TaxesDocuments implements ContractState {
    ...
    public TaxesDocuments(Party applicant, Party validater, int numberOfFiles, List<String> namesOfFiles) {
